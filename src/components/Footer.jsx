        ...
        <footer className='relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300'>
            <div className='w-[85%] mx-auto py-16'>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <h2 className='font-bold text-xl text-white relative inline-block after:absolute after:-bottom-2 after:left-0 after:w-12 after:h-1 after:bg-gradient-to-r from-blue-500 to-purple-500'>
                            Newsletter
                        </h2>
                        ...
                        <div className='relative'>
                            <input
                                className='w-full h-[50px] bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl px-4 outline-none text-white placeholder:text-gray-400 focus:border-blue-500'
                                type="email"
                                placeholder='Enter your email'
                            />
                            <button className='absolute right-1 top-1 h-[42px] px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700'>
                                Subscribe
                            </button>
                        </div>
            ...
            <div className='hidden md:flex fixed bottom-6 right-6 flex-col gap-3 z-50'>
                <button
                    ...
                    className='relative w-14 h-14 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition'
                >
