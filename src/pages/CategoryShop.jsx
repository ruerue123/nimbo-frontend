// CategoryShop.jsx - Modern redesigned version
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <section className='relative h-[280px] mt-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 overflow-hidden'>
                ...
                <div className='relative w-[85%] md:w-[90%] h-full mx-auto flex flex-col justify-center items-center text-white z-10'>
                    <h1 className='text-5xl md:text-4xl sm:text-3xl font-bold mb-4 text-center capitalize'>{category || 'Category'}</h1>
                                ...
                                <div className='flex justify-between items-center flex-wrap gap-4'>
                                    ...
                                    <div className='flex items-center gap-3'>
                                        <select
                                            ...
                                            className='px-4 py-2 border border-gray-200 rounded-lg outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 text-gray-700 font-medium bg-white transition-all'
                                        >
