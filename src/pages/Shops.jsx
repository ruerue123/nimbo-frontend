...
const Shops = () => {
    ...
    return (
        <div>
           <Header/>
           <section className='bg-[url("http://localhost:3002/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
        ...
        <div className='py-2 flex flex-col gap-5'>
            <h2 className='text-3xl font-bold mb-3 text-slate-600'>Price</h2>
             ...
             <Range
                ...
                renderThumb={({ props }) => (
                    <div className='w-[15px] h-[15px] bg-[#42accf] rounded-full' {...props} />
